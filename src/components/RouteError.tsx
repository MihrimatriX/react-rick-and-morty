...
const RouteError = () => (
  <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center animate-fadeIn">
    <img
      ...
      aria-hidden="true"
    />
    <h1 className="text-5xl font-extrabold text-cyan-600 dark:text-cyan-400 mb-2">404</h1>
    <h2 className="text-2xl font-bold mb-2 text-gray-800 dark:text-gray-100">Kaybolmuş Bir Evrendesin!</h2>
    <p className="mb-6 text-gray-600 dark:text-gray-300 max-w-md">
      Aradığın sayfa bu evrende yok. Portalı kullanarak ana sayfaya dönebilirsin!
    </p>
    <Link
      to="/"
