...
const StatusIcon = ({ char }: StatusIconProps) => {
  if (char.status === "Alive")
    return (
      <img src={alive_icon} alt="Happy face emoji" className="w-5 inline-block align-middle" />
    );
  if (char.status === "Dead")
    return <img src={dead_icon} alt="Dead face emoji" className="w-5 inline-block align-middle" />;
  return (
    <img
      src={unknown_icon}
